...
const API_KEY = '31f1750303a44ee1a2112309776e667b';
let savedArticles = [];

// News by Source, 'Give me the news from $(source* (.*))'
intent('(give me | tell me | show me) (latest|recent|) news (from | by | on | in)  $(source* (.*))', (p) => {
...
//let NEWS_API_URL = `https://newsapi.org/v2/everything?apiKey=${API_KEY}`; 
 let NEWS_API_URL = 'https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=31f1750303a44ee1a2112309776e667b';
if(p.term.value) {
